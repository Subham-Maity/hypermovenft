...
const Features: React.FC = () => {
    ...
    return (
        <section className=" w-full p-8 bg-features-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center justify-center max-w-screen-xl mx-auto">
                <LargeCard
