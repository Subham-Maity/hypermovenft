...
const Banner = () => {
    return (
        <section className="flex w-full justify-center items-center bg-[url('https://market.fabwelt.com/assets/images/backgroup-secsion/bg-h7.jpg')] bg-cover bg-no-repeat bg-center">
            <div className="flex w-full items-center justify-center px-4 py-8 md:px-8 md:py-12 lg:px-16 lg:py-16 xl:px-24 xl:py-20 2xl:px-32 2xl:py-24">
                ...
                <div className="hidden md:flex w-full md:w-1/2 justify-center items-center">
                    <div className="relative max-w-[700px]">
                        <Image src="/aaa.png" layout="responsive" width={700} height={500} alt="Banner" />
                    </div>
                </div>
            </div>
        </section>
