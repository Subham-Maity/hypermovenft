...
const Banner = () => {
  return (
    <section className="flex w-full justify-center items-center bg-[url('https://market.fabwelt.com/assets/images/backgroup-secsion/bg-h7.jpg')]">
      ...
      <div className="w-1/2 flex items-start justify-center flex-col gap-4">
        <h1 className="text-6xl flex flex-col gap-4">
