    ...
    return (
        <div className="text-white w-full text-center  h-35 bg-[#1D1D24] py-8 md:py-16">
            <div className="flex flex-col px-4 md:px-16">
                <div
                    className="text-center font-extrabold text-transparent text-8xl bg-clip-text bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 ">
                    Collection
                </div>
                <div className="center">
                    ...
                    <Breadcrumb
                        ...
                        text={['Home', 'Collections', 'onsumables-164',]}
                    />
                </div>
            </div>
        </div>
