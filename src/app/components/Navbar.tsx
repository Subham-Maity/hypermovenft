...
import {FaSearch, FaBars, FaWallet} from "react-icons/fa";
...
// import { FaHillAvalanche } from "react-icons/all";
    ...
    return (
        <nav className="flex items-center justify-between bg-zinc-950 p-4">
            ...
            <div className="flex items-center space-x-4 ">
                ...
                {/*</span>*/}
                <SwitchNetwork
                    href={["/market?chain=1", "/market?chain=2", "/market?chain=3"]}
                    text={["Ethereum", "Polygon", "Avalanche"]}
                    // Child={[<Ethereum key={0} />, <Plygon key={1} />, <Avalanche key={1} />]}
                    Icons={[
                        <FaEthereum key={0} size={16}/>,
                        <BiShapePolygon key={1} size={16}/>,
                        <FaHive key={2} size={16}/>,
                    ]}
                />;
                <WalletManager/>
                <ProfileConnect/>

                {/*<MainButton title="Connect Wallet" classNames="text-sm lg:text-xl" icon={<FaWallet size={16}/>}/>*/}
            </div>
